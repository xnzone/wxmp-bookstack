module.exports = {
  type: 'cards',
  title: '西山经',
  subtitle: '西山区｜西次二经｜西次三经｜西次四经',
  description: '《西山经》记述华山、钱来山等西方山系，奇兽众多，昆仑丘神兽汇聚。',
  beasts: [
    {
      name: '羬羊',
    ...
    },
    {
      ...
      image: '',
      appearance: '状如狸，一目三尾',
      original: '有兽焉，其状如狸，一目而三尾，其名曰讙，其音如夺百声，是可以御凶，服之已瘅。',
      translation: '形似野猫，一只眼睛三条尾巴，声音能盖过百声，可以御凶，又可治黄疸。'
    },
    {
      name: '当扈',
      image: '',
      appearance: '状如雉，以其髯飞',
      original: '有鸟焉，其状如雉，以其髯飞，食之不眴目。',
      translation: '形似野鸡，用胡须飞行，吃了可使眼睛不花。'
    },
    {
      name: '蛮蛮（比翼鸟）',
      image: '',
      appearance: '状如凫而一翼一目，相得乃飞',
      original: '有鸟焉，其状如凫，而一翼一目，相得乃飞，其名曰蛮蛮，见则天下大水。',
      translation: '形似野鸭，只有一只翅膀一只眼睛，两只鸟合起来才能飞，即比翼鸟。'
    },
    {
      name: '穷奇',
      image: '',
      appearance: '状如虎而有翼，音如獆犬',
      original: '有兽焉，其状如虎而有翼，其音如獆犬，其名曰穷奇。',
      translation: '形似老虎有翅膀，叫声像嗥叫的狗，上古四凶之一。'
    },
    {
      name: '胜遇',
      image: '',
      appearance: '状如翟而赤，食鱼，见则大水',
      original: '有鸟焉，其状如翟而赤，其音如录，其名曰胜遇，是食鱼，见则其国大水。',
      translation: '形似长尾野鸡，红色，叫声如录声，吃鱼，出现则发大水。'
    }
  ]
};
