...
> 备注：如果你对MVCC记忆模糊了，可以再回顾下第3篇文章[《事务隔离：为什么你改了我还看不见？》](../../01-mysql-45/03-transation/)和第8篇文章[《事务到底是隔离的还是不隔离的？》](../../01-mysql-45/08-transation-isolate/)中的相关内容。
...
你可能还记得在第10篇文章[《 MySQL为什么有时候会选错索引？》](../../01-mysql-45/10-mysql-choose-wrong-index/)中我提到过，索引统计的值是通过采样来估算的。实际上，TABLE_ROWS就是从这个采样估算得来的，因此它也很不准。有多不准呢，官方文档说误差可能达到40%到50%。**所以，show table status命令显示的行数也不能直接使用。**
...
> 备注：关于InnoDB的崩溃恢复，你可以再回顾一下第2篇文章[《日志系统：一条SQL更新语句是如何执行的？》](../../01-mysql-45/02-how-sql-execut/)中的相关内容。
