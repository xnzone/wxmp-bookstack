...
在我们修改计数器值的时候， 计数器的正确值是 \`114\` （执行了 \`114\` 次 [INCR key](../string/incr.html#incr) 命令）， 因为我们将计数器的值设成了 \`0\` ， 所以 \`consistency-test.rb\` 会向我们报告说丢失了 \`114\` 个 [INCR key](../string/incr.html#incr) 命令。
